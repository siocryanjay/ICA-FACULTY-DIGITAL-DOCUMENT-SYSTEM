...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                 <form  method="POST" action="{{ route('designations.designation.store', $designation) }}" enctype="multipart/form-data">
                 @csrf
                 <div class="card-header"><strong>Upload New Designation File </strong> 
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8 input-group">
                                ...
                                <div class="input-group-append">
                                        <span class="input-group-text" id="basic-addon2"><i class="fas fa-award pr-2"></i></span>
                                    </div>
                                @error('design_name')
                    ...
                    <div class="card-footer">
                        ...
                        <i class="fas fa-award pr-2"></i>Upload Designation File
                        </button>
                    </div>
                </form> 
            </div>
