            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <form action="{{ route('search-user') }} " method="GET" role="search">
                                {{ csrf_field() }}
                                <div class="input-group col-sm-6 float-right">
                                    <input type="search" name="search" class="form-control" placeholder="Search Users" value="{{ old('emp_id') }}" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-inline-flex"> 
                                    <a href="{{ route('admin.users.show', $user->id) }}"><button type="button" class="btn btn-sm btn-success ml-3 px-3"><i class="fa fa-eye pr-1" aria-hidden="true"></i>Show User</button></a>
                                    <a href="{{ route('admin.users.edit', $user->id) }}"><button type="button" class="btn btn-sm btn-info ml-4 px-3"><i class="fas fa-pencil-alt pr-1"></i> Edit User</button></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
